...
const Banner = () => {
  const scrollToProducts = () => {
    const element = document.getElementById('seccion-destino');
    if (element) {
      ...
      <div className="grid lg:grid-cols-2 items-center justify-items-center gap-5">
        <div className="order-2 lg:order-1 flex flex-col justify-center items-center">
          ...
          <button
            ...
            className="text-lg md:text-xl bg-text2 text-white py-2 px-5 mt-10 hover:bg-hover2 rounded-lg cursor-pointer"
          >
            Ver Catálogo
          </button>
        </div>
